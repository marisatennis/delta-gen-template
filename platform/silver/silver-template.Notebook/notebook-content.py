...
# # Silver Notebook (Delta-Gen v2)
# This notebook uses Delta-Gen v2 to transform data from bronze to silver layer.
# **Features:**
...
FILE_PATH = "/lakehouse/default/Files/inputs/silver/example/customer.yaml"
FULL_LOAD = False
DEBUG = True
RUN_ID = None
...
try:
    DEFAULTS_PATH = "/lakehouse/default/Files/inputs/config/silver_defaults.yaml"
    ...
    df = builder.build(spark, debug=DEBUG, context=ctx, watermark_override=WATERMARK_OVERRIDE)
