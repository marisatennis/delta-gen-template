...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "83e71b9c-2532-413f-8ebe-d981d43e22bc",
# META       "default_lakehouse_name": "silver",
# META       "default_lakehouse_workspace_id": "0cd94338-5a8c-48b5-91fa-c31c145a3ebd",
# META       "known_lakehouses": [
# META         {
# META           "id": "83e71b9c-2532-413f-8ebe-d981d43e22bc"
# META         }
# META       ]
# META     },
# META     "environment": {}
...
# - resolve silver YAML configs into batches
# - ensure target schemas exist
# - run silver notebooks for each config
...
defaults_path = os.path.join(folder_path, "config/silver_defaults.yaml")
batch_config_path = os.path.join(folder_path, "config/silver_batches.yaml")
config_root = os.path.join(folder_path, "silver")

print("\n" + "=" * 100)
print(f"SILVER ORCHESTRATOR")
print("=" * 100)
...
for batch_id, items in grouped.items():
    for item in items:
        table = item["table"]
        notebook_name = table.policies.creation.notebook_name or "silver-template"
...
if failed_tasks:
    raise RuntimeError(
        f"Silver orchestration failed: {len(failed_tasks)}/{total_notebooks} notebook(s) failed."
    )
else:
